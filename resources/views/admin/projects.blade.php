...
@section('projects') active @endsection
            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Loyihalar bazasi</h5>
...
{{--                            <th>O'zgartirish</th>--}}
                        ...
                        @foreach($projects as $id => $item)
                            <tr>
                                ...
                                <td class="w-25"><img src="../img/projects/{{ $item->project_photo }}" alt="" class="img-fluid"></td>
                ...
                <div class="">
                    <div class="card">
                        ...
                        <div class="card-body h-100">
                            <form action="{{ route('admin.add.project') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
