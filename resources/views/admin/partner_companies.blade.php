...
@section('companies') active @endsection
            ...
            <div class="col-12 col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="card-title mb-0">Hamkor kompaniyalar bazasi</h5>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($companies as $id => $item)
                            <tr>
                                <td>{{ $item->partners_name }}</td>
                                <td><a href="{{ $item->partners_link }}" target="_blank">{{ $item->partners_link }}</a></td>
                                <td class="w-25"><img src="../img/companies/{{ $item->partners_photo }}" alt="" class="img-fluid"></td>

                                <td>
                                    <form action="{{ route('admin.delete.companies') }}" method="post">
                                        @csrf
                                        @method('delete')
                ...
                <div class="">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Yangi kompaniya qo'shish</h5>
                        </div>
                        <div class="card-body h-100">
                            <form action="{{ route('admin.add.companies') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="link" required type="text" class="form-control" placeholder="">
                                </div>
                                <div class="mb-3">
